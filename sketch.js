...
function draw() {
  ...
  let radiusChange1 = (sin(frameCount*0.02)+2)*19;
  let radiusChange2 = (sin(frameCount*0.03)+1)*10;
  let radiusChange3 = (sin(frameCount*0.04)+1)*6;
  let radiusChange4 = (sin(frameCount*0.05)+1)*2;

  ellipse(820, 0, 1104 + radiusChange1);
